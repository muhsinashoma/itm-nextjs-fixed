    ...
    return (
        <div className="p-6 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="border rounded-xl p-4 shadow-sm bg-white">
                    <p className="text-sm text-muted-foreground">Expired Warranty</p>
                    <p className="text-2xl font-semibold text-red-600">
                        {claims.filter((c) => c.warrantyStatus === "Expired").length}
                    </p>
                </div>
            </div>
            ...
            <div className="border rounded-xl bg-white shadow-sm">
                ...
                <div className="flex justify-between items-center p-4 border-b">
                    <span className="text-sm text-muted-foreground">
                        Showing {filtered.length} of {claims.length} entries
                    </span>
                        ...
                        <tbody>
                            {filtered.map((item, index) => (
                                ...
                                >
                                    ...
                                    <td className="p-4"><WarrantyBadge status={item.warrantyStatus} /></td>
                                    <td className="p-4">
                                        <ActionsDropdown
                                            item={item}
